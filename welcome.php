...
<body>
  ...
  <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" class="scrollspy-example bg-body-tertiary p-3 rounded-2" tabindex="0">  
    ...
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
      <h1 style="-webkit-text-fill-color: blue;">Hi..  &nbsp<b><u><?php echo $_SESSION['username']; ?></u></b> , Welcome to</h1>
      ...
      <div class="col-lg-6">
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-start">
          ...
          <a href="q1.php" class="btn btn-outline-secondary"><b>Q&A</b></a>
          <a href="homep.php" class="btn btn-outline-primary"><b>Get Started >></b></a>
        </div>
      </div>
    </div>
  </div>
